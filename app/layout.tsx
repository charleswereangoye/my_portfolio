...
// 1. CustomCursor import completely removed
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      {/* 2. Removed md:cursor-none from the very end of this class string! */}
      <body suppressHydrationWarning className={`${inter.className} flex flex-col md:flex-row min-h-screen bg-background text-foreground transition-colors duration-300`}>
        <ThemeProvider>
          <SmoothScroll>
            ...
            {/* 3. Removed <CustomCursor /> component */}
            ...
            <aside className="hidden md:flex w-48 fixed h-screen p-12 flex-col justify-between z-40">
              ...
              <div className="flex flex-col items-start space-y-6 text-foreground/50 mb-8">
                
                {/* LinkedIn */}
                <Magnetic>
                  <a href="https://www.linkedin.com/in/charles-were-angoye-21a661326" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground transition-colors" aria-label="LinkedIn">
                ...
                {/* Instagram */}
                <Magnetic>
                  <a href="https://instagram.com/chaleeblack" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground transition-colors" aria-label="Instagram">
                ...
                {/* X (formerly Twitter) */}
                <Magnetic>
                  <a href="https://x.com/chaleeblack" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground transition-colors" aria-label="X (Twitter)">
                ...
                {/* Facebook */}
                <Magnetic>
                  <a href="https://facebook.com/chaleeblack" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground transition-colors" aria-label="Facebook">
                ...
                {/* GitHub */}
                <Magnetic>
                  <a href="https://github.com/charleswereangoye" target="_blank" rel="noopener noreferrer" className="block hover:text-foreground transition-colors" aria-label="GitHub">
