...
// 1. Import your new Mobile Header component
      ...
      <body suppressHydrationWarning className={`${inter.className} flex flex-col md:flex-row min-h-screen bg-background text-foreground transition-colors duration-300`}>
        <ThemeProvider>
          <SmoothScroll>
            ...
            {/* 2. DROP THE NEW COMPONENT HERE (Replaces the old <nav className="md:hidden..."> block) */}
            <MobileHeader />

            {/* --- DESKTOP SIDEBAR (Remains exactly the same, hidden on mobile) --- */}
