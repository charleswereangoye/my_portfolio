    ...
    <div className="flex flex-col max-w-[1400px] w-full mt-12 pb-32 space-y-48">
      ...
      <div className="grid grid-cols-12 gap-12 items-center w-full">
        ...
        <div className="col-span-7 flex justify-center items-center">
          ...
          <div className="relative w-[480px] h-[480px] aspect-square rounded-full overflow-hidden border-2 border-foreground/20 dark:border-white shadow-2xl shadow-foreground/5 dark:shadow-white/5 bg-foreground/5 transition-all duration-300">
